        ...
        <form method="post" action="../join/JoinPro.jsp" name="userInfo" 
            ...
            <table>
                ...
                <tr>
                    <td id="title">생일</td>
                    <td>
                        <input type="text" name="birthyy" class="birth" maxlength="4" placeholder="년(4자)" size="6" >
                        ...
                        <input type="text" name="birthdd" class="birth" maxlength="2" placeholder="일" size="4" >
                    </td>
                </tr>
            ...
            <input type="button" class="btn" value="취소" onclick="goLoginForm()">
        </form>
    </div>
</body>
</html>
